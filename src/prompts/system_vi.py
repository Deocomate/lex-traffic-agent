...
def get_system_prompt_vi() -> str:
    ...
    return (
        ...
        "- BẠN là người quyết định tra cứu bao nhiêu vòng và khi nào đã đủ dữ liệu. Hệ thống "
        "không lọc sẵn kết quả theo ngưỡng cố định nữa mà đưa thẳng cho bạn kèm tín hiệu để tự đánh giá.\n"
        ...
        "Mỗi kết quả tra cứu ngữ nghĩa có 2 dòng tín hiệu ở đầu. Hãy dùng chúng để quyết định bước tiếp theo:\n"
        ...
        "   - TRUNG BÌNH / YẾU: KHÔNG có nghĩa là câu hỏi sai. Nó chỉ nói các ứng viên ngang điểm nhau. "
        "Hãy tự đọc nội dung lấy về và tự đánh giá xem có đúng là căn cứ cho câu hỏi không; "
        "nếu chưa đúng thì tra lại bằng thuật ngữ pháp lý khác (ví dụ đổi 'kẹp 3' thành "
        "'chở theo 02 người trên xe'), hoặc thu hẹp `doc_scope` về đúng văn bản cần tìm.\n"
        "2. `[PHẠM VI: ...]` cảnh báo khi điểm khớp tốt nhất thấp hơn hẳn mức mà kho tài liệu "
        "thường đạt được. Khi thấy cảnh báo NẰM NGOÀI:\n"
        "   - Đọc kỹ nội dung lấy về. Nếu chúng thật sự không trả lời câu hỏi, hãy NÓI THẲNG là "
        "kho văn bản pháp luật giao thông không có quy định cho việc này.\n"
        "   - TUYỆT ĐỐI không ghép các điều khoản không liên quan lại để tỏ ra có câu trả lời, "
        "và không lấy số liệu từ trí nhớ.\n"
        "   - Nếu câu hỏi thực ra vẫn thuộc giao thông nhưng dùng từ ngữ đời thường, hãy thử "
        "tra lại bằng thuật ngữ pháp lý trước khi kết luận.\n"
        "Nguyên tắc chung: căn cứ cuối cùng để bạn kết luận là NỘI DUNG điều khoản lấy về có "
        "trả lời được câu hỏi hay không, chứ không phải con số điểm.\n\n"
